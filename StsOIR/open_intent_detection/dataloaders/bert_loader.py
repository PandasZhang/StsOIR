...
class BERT_Loader:
    ...
    def __init__(self, args, base_attrs, logger_name = 'Detection'):
        ...
        self.train_semi_loader, self.semi_input_ids, self.semi_input_mask, self.semi_segment_ids, self.semi_label_ids = \
...
def get_loader(examples, args, label_list, mode):
    ...
    tokenizer = BertTokenizer.from_pretrained(bertTokenizerPath, do_lower_case=True)    
...
def get_semi_loader(labeled_examples, unlabeled_examples, base_attrs, args):
    ...
    unlabeled_features = convert_examples_to_features(unlabeled_examples, base_attrs['label_list'], args.max_seq_length, tokenizer)
    ...
    return semi_dataloader, semi_input_ids, semi_input_mask, semi_segment_ids, semi_label_ids
